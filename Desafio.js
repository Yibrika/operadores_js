...
const nuevaString = "todo se puede";

// Crea una variable numérica, puede ser cualquier número:
const nuevoNum = 32;

// Crea una variable booleana:
const nuevoBool = nuevoBool(3) ;
...
function numeroRandom() {
  ...
  var numeroRandom = Math.random(num)
  return numeroRandom
}
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var exclamación = "!"
  var agregarSimboloExclamacion= str + "srt!"
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var result = nombre.concat(Yibrika, " " , carreño);
  return result
}
...
function obtenerSaludo(nombre) {
  ...
  // "Martin" -> "Hola Martin!"
  // Tu código:
  var result = nombre.concat(hola, Yibrika, " ", apellido, );
      return result
}
